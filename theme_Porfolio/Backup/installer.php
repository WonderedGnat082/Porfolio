...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20250620_xavierperrasporfolio_cabe62563119c1ae1820_20250620193107_archive.zip';
        const ARCHIVE_SIZE       = '341980706';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'cabe625-20193107';
        const SECONDARY_PACKAGE_HASH = 'ce5e969-20193107';
